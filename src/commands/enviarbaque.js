...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('enviarbaque')
    .setDescription('Marca uma favela como baqueada (✅).')
    .addStringOption(option =>
      option
        .setName('favela')
        .setDescription('Escolha a favela que foi baqueada.')
        .setRequired(true)
  ...
  async execute(interaction) {
    ...
    try {
      const { status } = setFavelaStatus(favelaId, STATUS.BAQUEADOS.key);
      ...
      console.error('Erro no comando /enviarbaque:', error);
